...
\fl{}\moduleLeftDash\cl{ {\MODULE} crossing}\moduleRightDash\cl{}
\fl{ {\EXTENDS} TLC ,\, Sequences ,\, Integers}
\fl{}
\fl{ {\p@mmalgorithm} cross}
 \fl{ {\p@variable} states \.{=} \{ \} ,\, k \.{=} 0 ,\, s ,\, tower \.{=}
 {\langle} {\langle} 1 ,\, 2 ,\, 3 {\rangle} ,\, {\langle} {\rangle} ,\,
 {\langle} {\rangle} {\rangle} ,\,}
\fl{ {\p@define}}
\fl{ D \.{\defeq} {\DOMAIN} tower}
\fl{ {\p@end} {\p@define} {\p@semicolon}}
\fl{ {\p@begin}}
\fl{ A\@s{.5}\textrm{:}\@s{3}}
\fl{ {\p@if} s \.{=} 0 {\p@then}}
\fl{ {\p@print} states {\p@semicolon}}
\fl{ {\p@print} (\@w{END} ) {\p@semicolon}}
\fl{ {\p@elsif} s \.{\%} 2 \.{=} 0 {\p@then}}
\fl{ {\p@with} i \.{\in} \{ 9 ,\, 5 ,\, 3 ,\, 1 \} {\p@do}}
 \fl{ {\p@if} (}\al{15}{2}{ s \.{+} i \.{\notin} \{ 1 ,\, 5 ,\, 6 ,\, 9 ,\, 10
 ,\, 14 \} ) \.{\land} ( s \.{+} i \.{\leq} 15 ) \.{\land} ( s \.{+} i
 \.{\notin} states ) {\p@then}}
\fl{ k \.{:=} s \.{+} i {\p@semicolon}}
\fl{ states \.{:=} states \.{\cup} \{ k \} {\p@semicolon}}
\fl{ {\p@goto} A {\p@semicolon}}
\fl{ {\p@end} {\p@if}}\al{19}{2}{ {\p@semicolon}}
\fl{ {\p@end} {\p@with}}\al{20}{2}{ {\p@semicolon}}
\fl{ {\p@else}}
\fl{ {\p@with} i \.{\in} \{ 9 ,\, 5 ,\, 3 ,\, 1 \} {\p@do}}
 \fl{ {\p@if} (}\al{23}{2}{ s \.{-} i \.{\notin} \{ 1 ,\, 5 ,\, 6 ,\, 9 ,\, 10
 ,\, 14 \} ) \.{\land} ( s \.{+} i \.{\geq} 0 ) \.{\land} ( s \.{-} i
 \.{\notin} states ) {\p@then}}
\fl{ k \.{:=} s \.{-} i {\p@semicolon}}
\fl{ states \.{:=} states \.{\cup} \{ k \} {\p@semicolon}}
\fl{ {\p@goto} A {\p@semicolon}}
...
\fl{ {\VARIABLES} states ,\, k ,\, s ,\, tower ,\, pc}
\fl{}
\fl{}
\fl{ D \.{\defeq} {\DOMAIN} tower}
\fl{}
\fl{}
 \fl{ vars}\al{39}{1}{ \.{\defeq} {\langle} states ,\, k ,\, s ,\, tower ,\,
 pc {\rangle}}
\fl{}
...
\fl{ \.{\land}}\al{42}{1}{ states \.{=} \{ \}}
\fl{ \.{\land}}\al{43}{1}{ k}\al{43}{2}{ \.{=}}\al{43}{3}{ 0}
\fl{ \.{\land}}\al{44}{1}{ s}\al{44}{2}{ \.{=}}\al{44}{3}{ defaultInitValue}
 \fl{ \.{\land}}\al{45}{1}{ tower \.{=} {\langle} {\langle} 1 ,\, 2 ,\, 3
 {\rangle} ,\, {\langle} {\rangle} ,\, {\langle} {\rangle} {\rangle}}
\fl{ \.{\land}}\al{46}{1}{ pc \.{=}\@w{A}}
\fl{}
\fl{ A \.{\defeq}}\al{48}{2}{ \.{\land}}\al{48}{3}{ pc \.{=}\@w{A}}
\fl{ \.{\land}}\al{49}{1}{ {\IF}}\al{49}{2}{ s \.{=} 0}
\fl{ \.{\THEN}}\al{50}{1}{ \.{\land}}\al{50}{2}{ PrintT ( states )}
\fl{ \.{\land}}\al{51}{1}{ PrintT ( (\@w{END} ) )}
\fl{ \.{\land}}\al{52}{1}{ pc \.{'} \.{=}\@w{Done}}
\fl{ \.{\land}}\al{53}{1}{ {\UNCHANGED} {\langle} states ,\, k {\rangle}}
\fl{ \.{\ELSE}}\al{54}{1}{ \.{\land} {\IF}}\al{54}{3}{ s \.{\%} 2 \.{=} 0}
 \fl{ \.{\THEN}}\al{55}{1}{ \.{\land}}\al{55}{2}{ \E\, i \.{\in} \{ 9 ,\, 5
 ,\, 3 ,\, 1 \} \.{:}}
 \fl{ {\IF}}\al{56}{1}{ ( s \.{+} i \.{\notin} \{ 1 ,\, 5 ,\, 6 ,\, 9 ,\, 10
 ,\, 14 \} ) \.{\land} ( s \.{+} i \.{\leq} 15 ) \.{\land} ( s \.{+} i
 \.{\notin} states )}
\fl{ \.{\THEN}}\al{57}{1}{ \.{\land}}\al{57}{2}{ k \.{'} \.{=} s \.{+} i}
 \fl{ \.{\land}}\al{58}{1}{ states \.{'} \.{=} ( states \.{\cup} \{ k \.{'} \}
 )}
\fl{ \.{\land}}\al{59}{1}{ pc \.{'}}\al{59}{3}{ \.{=}}\al{59}{4}{\@w{A}}
 \fl{ \.{\ELSE}}\al{60}{1}{ \.{\land}}\al{60}{2}{ pc \.{'}}\al{60}{4}{
 \.{=}}\al{60}{5}{\@w{Done}}
\fl{ \.{\land}}\al{61}{1}{ {\UNCHANGED} {\langle} states ,\, k {\rangle}}
 \fl{ \.{\ELSE}}\al{62}{1}{ \.{\land}}\al{62}{2}{ \E\, i \.{\in} \{ 9 ,\, 5
 ,\, 3 ,\, 1 \} \.{:}}
 \fl{ {\IF}}\al{63}{1}{ ( s \.{-} i \.{\notin} \{ 1 ,\, 5 ,\, 6 ,\, 9 ,\, 10
 ,\, 14 \} ) \.{\land} ( s \.{+} i \.{\geq} 0 ) \.{\land} ( s \.{-} i
 \.{\notin} states )}
\fl{ \.{\THEN}}\al{64}{1}{ \.{\land}}\al{64}{2}{ k \.{'} \.{=} s \.{-} i}
 \fl{ \.{\land}}\al{65}{1}{ states \.{'} \.{=} ( states \.{\cup} \{ k \.{'} \}
 )}
\fl{ \.{\land}}\al{66}{1}{ pc \.{'}}\al{66}{3}{ \.{=}}\al{66}{4}{\@w{A}}
 \fl{ \.{\ELSE}}\al{67}{1}{ \.{\land}}\al{67}{2}{ pc \.{'}}\al{67}{4}{
 \.{=}}\al{67}{5}{\@w{Done}}
\fl{ \.{\land}}\al{68}{1}{ {\UNCHANGED} {\langle} states ,\, k {\rangle}}
\fl{ \.{\land}}\al{69}{1}{ {\UNCHANGED} {\langle} s ,\, tower {\rangle}}
\fl{}
\fl{}
\fl{ Terminating \.{\defeq} pc \.{=}\@w{Done} \.{\land} {\UNCHANGED} vars}
\fl{}
\fl{ Next}\al{74}{1}{ \.{\defeq}}\al{74}{2}{ A}
\fl{ \.{\lor} Terminating}
\fl{}
 \fl{ Spec}\al{77}{1}{ \.{\defeq}}\al{77}{2}{ Init \.{\land} {\Box} [ Next ]_{
 vars}}
\fl{}
